...
public class BookController implements Serializable {
    ...
    public String search(String searchValue){
        ...
        items=new ListDataModel(getFacade().search("select b from Book b where b.title LIKE '%"+title+"%' or author LIKE '%"+title+"%' or publisher LIKE '%"+title+"%' or description LIKE '%"+title+"%' "));
