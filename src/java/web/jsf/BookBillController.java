...
@SessionScoped
public class BookBillController implements Serializable {

    private BookBill current;
    ...
    public BookBill getSelected() {
        if (current == null) {
            current = new BookBill();
            selectedItemIndex = -1;
        }
        return current;
    }

    private BookBillFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("BookBillCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("BookBillUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("BookBillDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class BookBillControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            BookBillController controller = (BookBillController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "bookBillController");
            return controller.getBookBill(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof BookBill) {
                BookBill o = (BookBill) object;
                return getStringKey(o.getBillId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + BookBill.class.getName());
            }
        }
